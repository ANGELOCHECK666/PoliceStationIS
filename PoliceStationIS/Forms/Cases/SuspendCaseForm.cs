...
{
    public partial class SuspendCaseForm : Form
    {
        private readonly int caseId;

        public SuspendCaseForm(int id)
        {
            caseId = id;
        ...
        private void ConfigureForm()
        {
            ...
            Text = "Приостановление дела";
            lblTitle.Text = "Приостановление дела";
            lblTargetStatus.Text = "Приостановлено";
        }
        ...
        private bool ValidateAction()
        {
            ...
            {
                MessageBox.Show(
                    "Для этого дела уже установлен статус «Приостановлено».",
                    "Проверка",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Warning);
